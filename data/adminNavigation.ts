...
export const menu: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      child('/dashboard#automation-notification-engine', 'Automation & Notification Engine', '自动化与通知引擎'),
      child('/dashboard#internal-inbox', 'Internal Inbox', '内部收件箱'),
      child('/dashboard#unified-task-engine', 'Unified Task Engine', '统一任务引擎'),
  ...
  },
  {
    ...
    children: [
      ...
      child('/customer-center#offline-customer', 'Offline Customer', '后台代录客户'),
  ...
  },
  {
    ...
    children: [
      ...
      child('/system-settings#automation-rule-settings', 'Automation Rule Settings', '自动化规则设置'),
      child('/system-settings#notification-channel-settings', 'Notification Channel Settings', '通知渠道设置'),
      child('/system-settings#unified-task-sla-settings', 'Unified Task SLA Settings', '统一任务 SLA 设置'),
