...
const specs: DashboardSpec[] = [
  ...
  },
  {
    ...
    zh: '报价',
    table: 'quotations',
    select: 'quotation_id,service_request_id,current_version:version,total:total_amount,approval_status:status,created_at',
  ...
  },
  {
    ...
    zh: '发票',
    table: 'invoices',
    select: 'invoice_id,invoice_no,job_id,total:total_amount,status,created_at',
    idField: 'invoice_id',
  ...
  },
  {
    ...
    zh: '付款',
    table: 'payments',
    select: 'payment_id,invoice_id,amount,status,reconciled_at,created_at',
    idField: 'payment_id',
