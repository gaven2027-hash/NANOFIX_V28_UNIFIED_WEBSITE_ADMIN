...
export default function Page() {
  return (
    <AdminShell>
      <PageHeader eyebrow="网站与系统设置" title="Website & System Settings" description="Manage brand, APIs, RBAC, backup, automation settings, notification channels, SLA rules, diagnostics and audit logs. / 管理品牌、接口、权限、备份、自动化设置、通知渠道、SLA 规则、诊断和审计日志。" />
