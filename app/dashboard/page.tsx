...
import { DashboardLiveCore } from '@/components/DashboardLiveCore';
import { DashboardWarrantySatisfactionAlerts } from '@/components/DashboardWarrantySatisfactionAlerts';
...
export default function Page() {
  return (
    <AdminShell>
      ...
      <><DashboardLiveCore /><Dashboard /><DashboardWarrantySatisfactionAlerts /><AutomationNotificationWorkspace /><MenuAnchorSections route="/dashboard" /></>
    </AdminShell>
  );
}
