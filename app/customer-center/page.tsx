...
export default function Page() {
  return (
    <AdminShell>
      <PageHeader eyebrow="客户相关" title="Customer Center" description="View customer profiles, add offline unclaimed customers, review Claim Existing Account requests, binding, reviews, privacy redaction, portal records, PDPA requests, and customer quotations / invoices / warranties. / 查看客户档案、后台代录未认领客户、审核已有账号认领、绑定、评价、隐私脱敏、门户记录、PDPA 请求，以及客户报价、发票和保修单。" />
