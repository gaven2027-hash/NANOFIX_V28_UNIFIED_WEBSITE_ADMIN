...
export const dashboardSections: DashboardSectionConfig[] = [
  ...
  { key: 'todays-tasks', href: '/dashboard/todays-tasks', title: "Today’s Tasks", zh: '今日待处理事项', detailMode: 'tasks', helper: 'Pending daily actions from leads, inspections, quotes and invoices.' },
