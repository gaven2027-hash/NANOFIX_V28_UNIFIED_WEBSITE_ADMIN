...
export const systemSettingsSections: SystemSettingsSectionConfig[] = [
  ...
  { key: 'auth-management', href: '/system-settings/auth-management', title: 'Auth Management', zh: '认证与账号管理', tab: 'records', category: 'auth', sensitive: true, helper: 'Manage username, email, mobile and WhatsApp registration settings and account recovery actions.' },
