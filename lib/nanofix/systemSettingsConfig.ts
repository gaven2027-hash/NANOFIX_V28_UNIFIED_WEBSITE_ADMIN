...
export const systemSettingsSections: SystemSettingsSectionConfig[] = [
  ...
  { key: 'api-integrations', href: '/system-settings/api-integrations', title: 'API Integrations', zh: 'API 集成', tab: 'records', category: 'integrations', sensitive: true, helper: 'Record integration names and server-only environment variable references. Sensitive values stay in platform environment settings.' },
  { key: 'supabase-settings', href: '/system-settings/supabase-settings', title: 'Supabase Settings', zh: 'Supabase 设置', tab: 'records', category: 'supabase', sensitive: true, helper: 'Track Supabase project, URL, RLS and server-only setting references.' },
  { key: 'github-vercel-deployment-settings', href: '/system-settings/github-vercel-deployment-settings', title: 'GitHub / Vercel Deployment Settings', zh: 'GitHub/Vercel 部署设置', tab: 'records', category: 'deployment', sensitive: true, helper: 'Track GitHub/Vercel deployment settings, build commands and environment reminders.' },
  ...
  { key: 'roles', href: '/system-settings/roles', title: 'Roles', zh: '角色', tab: 'rbac', category: 'roles', sensitive: true, helper: 'Manage role notes and allowed permission groups.' },
  { key: 'auth-management', href: '/system-settings/auth-management', title: 'Auth Management', zh: '认证与账号管理', tab: 'rbac', category: 'auth', sensitive: true, helper: 'Review and manage member, engineer and admin account registration status, role assignment and account activation controls.' },
  ...
  { key: 'environment-variables-reminder', href: '/system-settings/environment-variables-reminder', title: 'Environment Variables Reminder', zh: '环境变量提醒', tab: 'records', category: 'environment', sensitive: true, helper: 'Track required environment variables and reminders. Values stay in platform environment settings.' }
];
