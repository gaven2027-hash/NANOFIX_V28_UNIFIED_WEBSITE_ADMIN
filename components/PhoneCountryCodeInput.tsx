...
const otherCountries: PhoneCountry[] = [
  ...
  { name: 'American Samoa', iso: 'AS', dialCode: '+1-684' },
  { name: 'Andorra', iso: 'AD', dialCode: '+376' },
  { name: 'Angola', iso: 'AO', dialCode: '+244' },
  { name: 'Anguilla', iso: 'AI', dialCode: '+1-264' },
  { name: 'Antigua and Barbuda', iso: 'AG', dialCode: '+1-268' },
  ...
  { name: 'Bahamas', iso: 'BS', dialCode: '+1-242' },
  ...
  { name: 'Bermuda', iso: 'BM', dialCode: '+1-441' },
  ...
  { name: 'British Virgin Islands', iso: 'VG', dialCode: '+1-284' },
  ...
  { name: 'Cayman Islands', iso: 'KY', dialCode: '+1-345' },
  ...
  { name: 'Dominica', iso: 'DM', dialCode: '+1-767' },
  { name: 'Dominican Republic', iso: 'DO', dialCode: '+1-809' },
  ...
  { name: 'Falkland Islands', iso: 'FK', dialCode: '+500' },
  ...
  { name: 'Grenada', iso: 'GD', dialCode: '+1-473' },
  { name: 'Guadeloupe', iso: 'GP', dialCode: '+590' },
  { name: 'Guam', iso: 'GU', dialCode: '+1-671' },
  { name: 'Guatemala', iso: 'GT', dialCode: '+502' },
  { name: 'Guernsey', iso: 'GG', dialCode: '+44-1481' },
  ...
  { name: 'Isle of Man', iso: 'IM', dialCode: '+44-1624' },
  ...
  { name: 'Jersey', iso: 'JE', dialCode: '+44-1534' },
  ...
  { name: 'Kosovo', iso: 'XK', dialCode: '+383' },
  ...
  { name: 'Montserrat', iso: 'MS', dialCode: '+1-664' },
  ...
  { name: 'Northern Mariana Islands', iso: 'MP', dialCode: '+1-670' },
  ...
  { name: 'Puerto Rico', iso: 'PR', dialCode: '+1-787' },
  { name: 'Qatar', iso: 'QA', dialCode: '+974' },
  { name: 'Reunion', iso: 'RE', dialCode: '+262' },
  { name: 'Romania', iso: 'RO', dialCode: '+40' },
  { name: 'Russia', iso: 'RU', dialCode: '+7' },
  { name: 'Rwanda', iso: 'RW', dialCode: '+250' },
  { name: 'Saint Barthelemy', iso: 'BL', dialCode: '+590' },
  { name: 'Saint Helena', iso: 'SH', dialCode: '+290' },
  { name: 'Saint Kitts and Nevis', iso: 'KN', dialCode: '+1-869' },
  { name: 'Saint Lucia', iso: 'LC', dialCode: '+1-758' },
  { name: 'Saint Martin', iso: 'MF', dialCode: '+590' },
  { name: 'Saint Pierre and Miquelon', iso: 'PM', dialCode: '+508' },
  { name: 'Saint Vincent and the Grenadines', iso: 'VC', dialCode: '+1-784' },
  ...
  { name: 'Sint Maarten', iso: 'SX', dialCode: '+1-721' },
  ...
  { name: 'Turks and Caicos Islands', iso: 'TC', dialCode: '+1-649' },
  ...
  { name: 'Vatican City', iso: 'VA', dialCode: '+379' },
...
export function PhoneCountryCodeInput({
  ...
  return (
    <div className={`grid w-full grid-cols-[30%_70%] gap-2 ${className}`}>
      <select
        aria-label="Country calling code / 国家区号"
        className={`${baseControlClass} min-w-0 rounded-2xl px-2 ${selectClassName}`}
        value={countryCode}
