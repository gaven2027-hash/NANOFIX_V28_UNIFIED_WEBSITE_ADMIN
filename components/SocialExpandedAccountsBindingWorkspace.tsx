...
const bindablePlatforms: BindablePlatform[] = [
  ...
  { platform: 'x_twitter', label: 'X / Twitter', zh: 'X / Twitter 账号', secretPrefix: 'VERCEL_SOCIAL_X_TWITTER', apiHint: 'X public post, thread and monitoring metadata' },
  { platform: 'carousell_services', label: 'Carousell Services', zh: 'Carousell 服务账号', secretPrefix: 'VERCEL_SOCIAL_CAROUSELL', apiHint: 'Carousell local services listing and lead handoff metadata' },
  { platform: 'seedly_community', label: 'Seedly Community', zh: 'Seedly 社区账号', secretPrefix: 'VERCEL_SOCIAL_SEEDLY', apiHint: 'Seedly community monitoring and answer-draft metadata' },
