      ...
      {canRespond ? (
        <div className="mt-4 rounded-3xl bg-white p-4 ring-1 ring-slate-200">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <button type="button" onClick={() => onRespond?.(quotationId, 'accepted', message)} disabled={responding} className="rounded-2xl bg-emerald-600 px-4 py-3 text-xs font-black text-white hover:bg-emerald-700 disabled:opacity-50">{responding ? 'Submitting… / 提交中…' : 'Accept Quote / 接受报价'}</button>
