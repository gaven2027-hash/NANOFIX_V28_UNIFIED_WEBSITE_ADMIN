...
const v282WorkflowChecks = {
  ...
  global_search_includes_workflow_settings: ["workflow_settings", "workflowSettingHref", "/system-settings#automation-rule-settings", "/system-settings#notification-channel-settings", "/system-settings#unified-task-sla-settings", "GLOBAL_SEARCH_TABLE_ALLOWLIST", "allowedSearchConfigs", "explicit_table_allowlist", "rpcRetired: true", "rpc_retired: true"].every((marker) => globalSearchText.includes(marker)),
